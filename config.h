...
static const char *fonts[]          = { "noto-fonts:size=14" };
static const char dmenufont[]       = "noto-fonts:size=14";
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,			    XK_x,	   spawn,		   SHCMD("[ $(echo -e 'Yes\nNO' | dmenu -i -p 'Shutdown?') == 'Yes' ] && shutdown now")},
	{ MODKEY|ShiftMask,				XK_r,      spawn,		   SHCMD("[ $(echo -e 'Yes\nNO' | dmenu -i -p 'Restart?') == 'Yes' ] && reboot")},
	{ MODKEY|ShiftMask,				XK_s,      spawn,		   SHCMD("[ $(echo -e 'Yes\nNO' | dmenu -i -p 'Sleep?') == 'Yes' ] && systemctl sleep")},
